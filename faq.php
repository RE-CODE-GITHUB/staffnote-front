...
<head>
    ...
    <title>よくある質問 - 店舗に特化した無料情報共有ツール</title>
</head>
<body>
<!-- Main container -->
...
<div class="bloc l-bloc bgc-white" id="bloc-17">
	<div class="container bloc-md">
		<div class="row">
			<div class="col-sm-12">
				<h1 class="mg-md animated fadeIn text-left text-center">
					よくある質問<br />
				</h1>
				<h3 class="mg-md animated fadeIn">
					<span class="fa fa-pencil-square-o"></span> Notellerは, 本当に無料で使えるのでしょうか？
				</h3>
				<blockquote>
					<p class="animated fadeIn">
						はい。全ての機能を無料でご提供しています。
					</p>
				</blockquote>
			</div>
		</div>
