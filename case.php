...
<head>
    ...
    <title>導入事例 - 店舗に特化した無料情報共有ツール</title>
</head>
<body>
<!-- Main container -->
...
<div class="bloc l-bloc bgc-white" id="bloc-10">
	<div class="container bloc-md">
		<div class="row">
			<div class="col-sm-12 sumaho_saiyou">
		...
		<div class="row voffset">
			<div class="col-sm-6">
				<img src="img/smile.jpg" class="img-frame animated fadeIn" height="380" />
			</div>
			<div class="col-sm-6">
				<h2 class="mg-md animated fadeIn ">
					・StaffNoteを導入し、店舗経営が楽になった
				</h2>
				<h2 class="mg-md animated fadeIn ">
					・他のスタッフのミスが減少
				</h2>
				...
				<h2 class="mg-md text-center animated fadeIn ">
					<br /><br />上記のような感想を待っています。<br /><br /><br />
				</h2><a href="info.php" class="btn   btn-yale-blue btn-lg btn-block animated fadeIn">感想を伝えてみる <span class="fa fa-chevron-circle-right icon-spacer"></span></a>
			</div>
		</div>
	</div>
</div>
